...
class ThreeStar extends StatefulWidget {
  const ThreeStar({Key? key}) : super(key: key);

  @override
  _ThreeStarState createState() => _ThreeStarState();
}

class _ThreeStarState extends State<ThreeStar> {
  static const url = 'http://goclean5yeoja.com/view_review_3.php';
  List revlist = [];
        ...
        Flexible(
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                return Text("Total 3 Star Reviews : ${revlist.length}",
                  style: TextStyle(
