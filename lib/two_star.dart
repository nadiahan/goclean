...
class TwoStar extends StatefulWidget {
  const TwoStar({Key? key}) : super(key: key);

  @override
  _TwoStarState createState() => _TwoStarState();
}

class _TwoStarState extends State<TwoStar> {
  static const url = 'http://goclean5yeoja.com/view_review_2.php';
  List revlist = [];
        ...
        Flexible(
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                return Text("Total 2 Star Reviews : ${revlist.length}",
                  style: TextStyle(
