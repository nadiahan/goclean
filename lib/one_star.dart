...
class OneStar extends StatefulWidget {
  const OneStar({Key? key}) : super(key: key);

  @override
  _OneStarState createState() => _OneStarState();
}

class _OneStarState extends State<OneStar> {
  static const url = 'http://goclean5yeoja.com/view_review_1.php';
  List revlist = [];
        ...
        Flexible(
          child: FutureBuilder(
              ...
              builder: (context, snapshot) {
                return Text("Total 1 Star Reviews : ${revlist.length}",
                  style: TextStyle(
